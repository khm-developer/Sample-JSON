...
(function($){ 	
	...
	//h.append("<style type='text/css'>  .JCLRFlex{width: auto !important;}  .JColResizer{table-layout:fixed;}  .JPadding > tbody > tr > td, .JPadding > tbody > tr > th{padding-left:0!important; padding-right:0!important;} .JCLRgrips{ height:0px; position:relative;z-index:11;} .JCLRgrip{margin-left:-1px; position:absolute; z-index:5; } .JCLRgrip.thdropdownlist{ margin-left:-5px !important; } .JCLRgrip:nth-last-child(2){ margin-left:-5px !important; }  .JCLRgrip:nth-last-child(1){ margin-left:-5px !important; } .JCLRgrip .JColResizer{position:absolute;background-color:red;filter:alpha(opacity=1);opacity:0;width:10px;height:100%;cursor: col-resize;top:0px} .JCLRLastGrip{position:absolute; width:1px; } .JCLRgripDrag{ border-left:1px dotted black;	} .JCLRgrip.JCLRdisabledGrip .JColResizer{cursor:default; display:none;}  .JCLRgrip {max-height: 48px;}</style>");
